...
var getBoard, setBoard, saveBoardJson, loadBoardJson, rowPeers, colPeers, peers, memoized, getPossible, sum, str2bin, bin2str, intersection, difference, solved, solvedCells, assertTotal, getPossible2, testPossible, numSolved, assign, solve;
getBoard = function(){
...
getPossible = function(total, length, left){
  var cached, possible, i$, len$, i, rest, j$, len1$, x;
  ...
  return memoized[[total, length, left]] = Array.from(possible).join('');
};
